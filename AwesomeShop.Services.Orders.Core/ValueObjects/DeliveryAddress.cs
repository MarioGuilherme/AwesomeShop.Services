...
public class DeliveryAddress(string street, string number, string city, string state, string zipCode) {
    ...
    public override bool Equals(object? obj) => obj is DeliveryAddress address
